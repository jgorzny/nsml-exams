...
class Question(models.Model):
    ...
    figure_one = models.FileField(default='')
    figure_two = models.FileField(default='')
    figure_three = models.FileField(default='')
...
class QuestionForm(ModelForm):
    class Meta:
        ...
        'figure_one','figure_two','figure_three','latex_figure_one','latex_figure_two', 'latex_figure_three']